# Program to cut Nikau's art assignment; minimally changed from mousepad.py.
...
# PARAMETERS:
imfile = "../../../Bible/back.png"
outputWidth = 116  #  width of desired output, in millimetres
outfile = "BackCover.gcode"  #  widest point is about 72 pixels

vBitAngle = 20  #  bit angle in degrees
vBitWidth = 3.175
sfht = 3  #  3 mm ain't much but ought to suffice
sanddepth = 0.2  #  cut this much deeper, so a groove remains after sanding 

image = io.imread(imfile, as_gray=True).astype(float) > 0.5  #  reversed from mousepad!
